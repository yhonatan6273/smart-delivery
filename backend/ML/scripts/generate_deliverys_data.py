import numpy as np
import pandas as pd
#this function generates a list of a random deliverys data
def make_random_deliverys(number_deliverys):
    ...
    for _ in range(number_deliverys):
        ...
        delivery_information = {
            ...
            #the time of arriving to destination in minutes according to maps
...
df.to_csv("ML/data/deliverys_data.csv", index=False)
